    ...
    <div className=' overflow-hidden fixed w-[100vw] z-50  bg-[#2b2626b2] shadow-md h-[5rem] px-[3%]'>
      <div className='max-w-[1400px] h-[100%] w-[100%]'>
       <div className='flex justify-between text-white items-center align-middle max-md:pt-[0.8rem] md:pt-[0.5rem]'>
        ...
        <div className='text-[18px] font-[700] ml-[20%] max-lg:hidden leading-[30px] capitalize'>
      ...
      {/* </a> */}
            <a href='tel:836 225 1917' className='border-0 max-md:hidden px-[1rem] rounded-l-full py-1 rounded-r-full text-white bg-orange-400'>+91 836 225 1917</a>
        </div>
      </div>
      </div>
    ...
    <div className='flex text-white flex-col gap-5 text-[18px]  justify-center items-center mt-[2rem] font-semibold tracking-wider leading-[30px]'>
      ...
      <SignedOut>
        <SignInButton mode='modal' />
            ...
            {/* <a href='#' className='text-gray-900 hover:text-orange-400'> */}
      {/* </a> */}
            <a href='tel:836 225 1917' className='border-0 px-[1.5rem] rounded-md   py-1 text-black bg-orange-400'>Connect</a>
        </div>
  </div>
</div>
    </div>
