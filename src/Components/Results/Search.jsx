...
export default function Searchs({datas}) {
  console.log(data)
  ...
  return (
    ...
    <div className='text-black flex gap-5 bg-gray-100 mb-[1rem] justify-between items-center font-bold w-[100vw] max-lg:px-[3%] lg:px-[10%]'>
        ...
        <div className='flex  md:gap-10 max-md:gap-2 py-2'>
            ...
            <span className='max-md:text-xs'>{datas?.PickUp} </span>
            ...
            <div className='flex flex-col gap-1'>
                ...
                <span className='max-md:text-xs'>{datas?.PickUpAt} </span>
     ...
     { dt?.map((data)=><div className='flex max-lg:hidden justify-around w-[100%] mb-[0.5rem] gap-36 items-center border-[1px] border-orange-400 px-[2rem] py-1 rounded-xl'> 
