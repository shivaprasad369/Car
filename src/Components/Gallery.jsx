...
export default function StandardImageList() {
  ...
  return (
    <div id='gallery' className='md:px-[5%] flex flex-col justify-center items-center w-[100%] max-md:px-[3%] my-[2rem]'>
    ...
    <button type="button" className='text-white font-bold bg-orange-400 px-2 py-2 mt-[2rem] justify-center items-center' onClick={() => setExpanded(!expanded)}>
